...
with open(os.path.join(args.path, args.appen+args.ood_dataset+'_'+args.postprocessor+'.csv'), 'a+') as fl1:
    writer = csv.writer(fl1)  
    writer.writerow([ ood_metrics[0] * 100, ood_metrics[1] * 100, ID_ACC * 100]) 
