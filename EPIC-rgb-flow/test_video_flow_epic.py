...
if __name__ == '__main__':
    ...
    for split in splits:
        ...
        if args.far_ood:
            output_name = '../HMDB-rgb-flow/saved_files/id_'+args.dataset+'_ood_'+ args.ood_dataset + '_output_' + args.appen + split + '.npy'
            pred_name = '../HMDB-rgb-flow/saved_files/id_'+args.dataset+'_ood_'+ args.ood_dataset + '_pred_' + args.appen + split + '.npy'
            conf_name = '../HMDB-rgb-flow/saved_files/id_'+args.dataset+'_ood_'+ args.ood_dataset + '_conf_' + args.appen + split + '.npy'
            label_name = '../HMDB-rgb-flow/saved_files/id_'+args.dataset+'_ood_'+ args.ood_dataset + '_label_' + args.appen + split + '.npy'
            feature_name = '../HMDB-rgb-flow/saved_files/id_'+args.dataset+'_ood_'+ args.ood_dataset + '_feature_' + args.appen + split + '.npy'
        else:
